...
@onready var waves_remaining_label = $MarginContainer/Background/MarginContainer/MarginContainer/Background/MarginContainer/VBoxContainer/WavesRemainingLabel
